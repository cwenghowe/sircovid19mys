...
$$
RSS = w_1\sum({ln{I} - ln{\hat I}})^2 + w_2\sum({ln{R} - ln{\hat R}})^2
$$
where $w_1$ and $w_2$ allow adjustment of weightage given to *I* or *R* respectively to balance the model fit. We are inclined to give more weight to *I* through $w_1$.
...
fitplot1 = ggplot(fitted_projected, aes(x = Date)) + geom_line(aes(y = I, color = "Infectious")) + 
  ...
  labs(y = "Number of cases", title = paste("COVID-19 SIR model Malaysia, fitted and observed", name),
       ...
       color = paste0("MAPE 1 = ", round(mape1,3), "\n",
                      "MAPE 2 = ", round(mape2,3), "\n",
