...
fitplot1
# ggsave(paste0("plots_sr/fit", name, ".png"), width = 16, height = 10)
...
fitplot1_log = ggplot(fitted_projected, aes(x = Date)) + geom_line(aes(y = I, color = "Infectious")) + 
  ...
  scale_colour_manual(values = colors)  
fitplot1_log
# ggsave(paste0("plots_sr/fit", name, "_log.png"), width = 16, height = 10)
...
sirplot1
# ggsave(paste0("plots_sr/sir", name, ".png"), width = 16, height = 10)
...
sirplot1_log = ggplot(fitted_projected, aes(x = Date)) + 
  ...
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
sirplot1_log
# ggsave(paste0("plots_sr/sir", name, "_log.png"), width = 16, height = 10)
